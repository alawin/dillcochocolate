...
export default class About extends Component {
    render() {
        return (
            <TwoColumn
            leftTitle="What is Inside cocoa pod?"
            leftText1= "While the average number of cocoa beans in one pod is around 40, the actual number of beans can vary between 20 and 60 or so. Cocoa beans, the base for making chocolate, are the seeds of the cocoa tree. They are found inside the cocoa pods, surrounded by a sweet white pulp"
            rightTitle="About"
